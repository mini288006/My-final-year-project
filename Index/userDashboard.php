...
if (!isset($_SESSION["User_tag"]) || !isset($_SESSION["USER_ID"])) {
    echo "<p style='color:red;'>You must be logged in to view your tournaments.</p>";
    exit;
}
...
<div class="main_content">
            ...
            <div class="tournament-gallery" id="tournamentGallery">
                <?php while ($row = mysqli_fetch_assoc($result)): ?>
                    <div class="tournament-card">
                        <a href="Styling/signedtournamentdetails.php?id=<?php echo urlencode($row['TOURNAMENT_ID']); ?>">
    ...
    <?php else: ?>
        <p style="color: white;">You have not registered for any tournaments yet.</p>
    <?php endif; ?>
</div>
